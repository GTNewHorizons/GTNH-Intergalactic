...
public class BlockDysonSwarmPart extends Block {
	...
	public static final String[] names = new String[] {"ReceiverCasing", "ReceiverDish", "DeploymentUnitCasing", "DeploymentUnitCore", "DeploymentUnitMagnet", "ControlCasing", "ControlPrimary", "ControlSecondary", "ControlToroid", "Floor"};
	...
	@Override
	public float getExplosionResistance(Entity entity) { // this *should* not be called, but mods like WAWLA do it anyways. Since differentiating between
		return 6.0f;                                     // different meta values is not possible, we only return "the norm" and not "the exception" (meta == 9)
	}
