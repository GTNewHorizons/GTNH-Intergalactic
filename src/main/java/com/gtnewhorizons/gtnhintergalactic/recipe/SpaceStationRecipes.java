...
public class SpaceStationRecipes {
    ...
    public static void loadRecipes() {
        ...
        if(GSConfigDimensions.enableSaturnSS) {
            ...
            GalacticraftRegistry.registerSpaceStation(new SpaceStationType(GSConfigDimensions.dimensionIDSaturnOrbit, GSConfigDimensions.dimensionIDSaturn, new SpaceStationRecipe(inputMap)));
        }
        if(GSConfigDimensions.enableUranusSS) {
            ...
            inputMap.put("circuitMaster", 4);
            inputMap.put(new ItemStack(GregTech_API.sBlockMachines, 1, 16), 1); //LuV Machine Hull
            GalacticraftRegistry.registerSpaceStation(new SpaceStationType(GSConfigDimensions.dimensionIDUranusOrbit, GSConfigDimensions.dimensionIDUranus, new SpaceStationRecipe(inputMap)));
        }
        if(GSConfigDimensions.enableNeptuneSS) {
            ...
            GalacticraftRegistry.registerSpaceStation(new SpaceStationType(GSConfigDimensions.dimensionIDNeptuneOrbit, GSConfigDimensions.dimensionIDNeptune, new SpaceStationRecipe(inputMap)));
        }
    }
