...
public class CraftingRecipes {
    ...
    public static void loadRecipes() {
        ...
        RA.addAssemblerRecipe(new ItemStack[]{new ItemStack(AsteroidsItems.basicItem, 1, 7), GT_OreDictUnificator.get(OrePrefixes.foil, Materials.Titanium, 8), ItemList.TungstenString.getIS(8), GT_Utility.getIntegratedCircuit(1)}, Materials.Polybenzimidazole.getMolten(576), new ItemStack(GSItems.ThermalClothTier2), 600, 1024);
        RA.addAssemblerRecipe(new ItemStack[]{new ItemStack(GSItems.ThermalClothTier2, 5), ItemList.TungstenString.getIS(5), GT_Utility.getIntegratedCircuit(5)}, Materials.Polybenzimidazole.getMolten(1440), new ItemStack(GSItems.ThermalPaddingTier2), 1500, 1920);
        RA.addAssemblerRecipe(new ItemStack[]{new ItemStack(GSItems.ThermalClothTier2, 8), ItemList.TungstenString.getIS(8), GT_Utility.getIntegratedCircuit(8)}, Materials.Polybenzimidazole.getMolten(2304), new ItemStack(GSItems.ThermalPaddingTier2, 1, 1), 2400, 1920);
        RA.addAssemblerRecipe(new ItemStack[]{new ItemStack(GSItems.ThermalClothTier2, 7), ItemList.TungstenString.getIS(7), GT_Utility.getIntegratedCircuit(7)}, Materials.Polybenzimidazole.getMolten(2016), new ItemStack(GSItems.ThermalPaddingTier2, 1, 2), 2100, 1920);
        RA.addAssemblerRecipe(new ItemStack[]{new ItemStack(GSItems.ThermalClothTier2, 4), ItemList.TungstenString.getIS(4), GT_Utility.getIntegratedCircuit(4)}, Materials.Polybenzimidazole.getMolten(1152), new ItemStack(GSItems.ThermalPaddingTier2, 1, 3), 1200, 1920);
        ...
        RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get("oc:case1", 1), GT_OreDictUnificator.get("oc:keyboard", 1), ItemList.Display.getIS(), getGTItem(32682), getGTItem(32692), new ItemStack(GCItems.heavyPlatingTier1)}, Materials.SolderingAlloy.getMolten(576), new ItemStack(GSItems.ControlComputer, 1, 1), 600, 480, true);
        RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get("oc:case1", 1), GT_OreDictUnificator.get("oc:keyboard", 1), ItemList.Display.getIS(), getGTItem(32682), getGTItem(32692), new ItemStack(MarsItems.marsItemBasic, 1, 3)}, Materials.SolderingAlloy.getMolten(864), new ItemStack(GSItems.ControlComputer, 1, 2), 600, 1920, true);
        RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get("oc:case1", 1), GT_OreDictUnificator.get("oc:keyboard", 1), ItemList.Display.getIS(), getGTItem(32683), getGTItem(32693), new ItemStack(AsteroidsItems.basicItem)}, Materials.SolderingAlloy.getMolten(1152), new ItemStack(GSItems.ControlComputer, 1, 3), 600, 7680, true);
        RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get("oc:case2", 1), GT_OreDictUnificator.get("oc:keyboard", 1), ItemList.Display.getIS(), getGTItem(32684), getGTItem(32694), ItemList.HeavyDutyPlateTier4.getIS()}, Materials.SolderingAlloy.getMolten(1728), new ItemStack(GSItems.ControlComputer, 1, 4), 600, 7680, true);
        RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get("oc:case2", 1), GT_OreDictUnificator.get("oc:keyboard", 1), ItemList.Display.getIS(), getGTItem(32685), getGTItem(32695), ItemList.HeavyDutyPlateTier5.getIS()}, Materials.SolderingAlloy.getMolten(2304), new ItemStack(GSItems.ControlComputer, 1, 5), 600, 30720, true);
        RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get("oc:case3", 1), GT_OreDictUnificator.get("oc:keyboard", 1), ItemList.Display.getIS(), getGTItem(32686), getGTItem(32696), ItemList.HeavyDutyPlateTier6.getIS()}, Materials.SolderingAlloy.getMolten(3456), new ItemStack(GSItems.ControlComputer, 1, 6), 600, 122880, true);
        RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get("oc:case3", 1), GT_OreDictUnificator.get("oc:keyboard", 1), ItemList.Display.getIS(), getGTItem(32687), getGTItem(32697), ItemList.HeavyDutyPlateTier7.getIS()}, Materials.SolderingAlloy.getMolten(4608), new ItemStack(GSItems.ControlComputer, 1, 7), 600, 491520, true);
        RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get("oc:case3", 1), GT_OreDictUnificator.get("oc:keyboard", 1), ItemList.Display.getIS(), getGTItem(32687), getGTItem(32697), ItemList.HeavyDutyPlateTier8.getIS()}, Materials.SolderingAlloy.getMolten(6912), new ItemStack(GSItems.ControlComputer, 1, 8), 600, 491520, true);
        ...
        RecipeUtil.addRecipe(new ItemStack(GCBlocks.nasaWorkbench), new Object[]{"RRR", "CDC", "WAW", 'R', new ItemStack(GSItems.RobotArm), 'C', "circuitElite", 'D', ItemList.Display.getIS(), 'W', new ItemStack(openmodularturrets.blocks.Blocks.hardWallTierFour), 'A', new ItemStack(GregTech_API.sBlockMachines, 1, 213)});
