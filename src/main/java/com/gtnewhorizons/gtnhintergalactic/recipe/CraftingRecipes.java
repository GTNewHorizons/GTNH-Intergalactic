...
public class CraftingRecipes {
    ...
    public static void loadRecipes() {
        ...
        //Circuit Assembler
        RA.addCircuitAssemblerRecipe(new ItemStack[]{new ItemStack(GCItems.heavyPlatingTier1), GT_OreDictUnificator.get("oc:keyboard", 1), ItemList.Display.getIS(), getGTItem(32682), getGTItem(32692)}, Materials.SolderingAlloy.getMolten(576), new ItemStack(GSItems.ControlComputer, 1, 1), 600, 480, true);
        RA.addCircuitAssemblerRecipe(new ItemStack[]{new ItemStack(MarsItems.marsItemBasic, 1, 3), GT_OreDictUnificator.get("oc:keyboard", 1), ItemList.Display.getIS(), getGTItem(32682), getGTItem(32692)}, Materials.SolderingAlloy.getMolten(864), new ItemStack(GSItems.ControlComputer, 1, 2), 600, 1920, true);
        RA.addCircuitAssemblerRecipe(new ItemStack[]{new ItemStack(AsteroidsItems.basicItem), GT_OreDictUnificator.get("oc:keyboard", 1), ItemList.Display.getIS(), getGTItem(32683), getGTItem(32693)}, Materials.SolderingAlloy.getMolten(1152), new ItemStack(GSItems.ControlComputer, 1, 3), 600, 7680, true);
        RA.addCircuitAssemblerRecipe(new ItemStack[]{ItemList.HeavyDutyPlateTier4.getIS(), GT_OreDictUnificator.get("oc:keyboard", 1), ItemList.Display.getIS(), getGTItem(32684), getGTItem(32694)}, Materials.SolderingAlloy.getMolten(1728), new ItemStack(GSItems.ControlComputer, 1, 4), 600, 7680, true);
        RA.addCircuitAssemblerRecipe(new ItemStack[]{ItemList.HeavyDutyPlateTier5.getIS(), GT_OreDictUnificator.get("oc:keyboard", 1), ItemList.Display.getIS(), getGTItem(32685), getGTItem(32695)}, Materials.SolderingAlloy.getMolten(2304), new ItemStack(GSItems.ControlComputer, 1, 5), 600, 30720, true);
        RA.addCircuitAssemblerRecipe(new ItemStack[]{ItemList.HeavyDutyPlateTier6.getIS(), GT_OreDictUnificator.get("oc:keyboard", 1), ItemList.Display.getIS(), getGTItem(32686), getGTItem(32696)}, Materials.SolderingAlloy.getMolten(3456), new ItemStack(GSItems.ControlComputer, 1, 6), 600, 122880, true);
        RA.addCircuitAssemblerRecipe(new ItemStack[]{ItemList.HeavyDutyPlateTier7.getIS(), GT_OreDictUnificator.get("oc:keyboard", 1), ItemList.Display.getIS(), getGTItem(32687), getGTItem(32697)}, Materials.SolderingAlloy.getMolten(4608), new ItemStack(GSItems.ControlComputer, 1, 7), 600, 491520, true);
        RA.addCircuitAssemblerRecipe(new ItemStack[]{ItemList.HeavyDutyPlateTier8.getIS(), GT_OreDictUnificator.get("oc:keyboard", 1), ItemList.Display.getIS(), getGTItem(32687), getGTItem(32697)}, Materials.SolderingAlloy.getMolten(6912), new ItemStack(GSItems.ControlComputer, 1, 8), 600, 491520, true);
        RA.addCircuitAssemblerRecipe(new ItemStack[]{new ItemStack(GCItems.heavyPlatingTier1), new ItemStack(GCItems.basicItem, 1, 14), GT_OreDictUnificator.get("circuitData", 1), getGTItem(32682), getGTItem(32692)}, Materials.SolderingAlloy.getMolten(576), new ItemStack(GSItems.ControlComputer, 1, 100), 600, 480, true);
        RA.addCircuitAssemblerRecipe(new ItemStack[]{new ItemStack(MarsItems.marsItemBasic, 1, 3), new ItemStack(GCItems.basicItem, 1, 14), GT_OreDictUnificator.get("circuitElite", 1), getGTItem(32683), getGTItem(32693)}, Materials.SolderingAlloy.getMolten(864), new ItemStack(GSItems.ControlComputer, 1, 101), 600, 1920, true);
        RA.addCircuitAssemblerRecipe(new ItemStack[]{new ItemStack(AsteroidsItems.basicItem), new ItemStack(GCItems.basicItem, 1, 14), GT_OreDictUnificator.get("circuitMaster", 1), getGTItem(32684), getGTItem(32694)}, Materials.SolderingAlloy.getMolten(1152), new ItemStack(GSItems.ControlComputer, 1, 102), 600, 7680, true);
