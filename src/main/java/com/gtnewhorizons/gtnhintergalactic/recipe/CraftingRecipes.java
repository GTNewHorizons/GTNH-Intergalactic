...
public class CraftingRecipes {
    ...
    public static void loadRecipes() {
        ...
        RecipeUtil.addRecipe(new ItemStack(GSItems.RobotArm), new Object[]{"SRS", "CPC", "SMS", 'S', GT_OreDictUnificator.get(OrePrefixes.stick, Materials.StainlessSteel, 1), 'R', getGTItem(32652), 'C', "circuitAdvanced", 'P', getGTItem(32642), 'M', getGTItem(32602)});
        RecipeUtil.addRecipe(new ItemStack(GCBlocks.nasaWorkbench), new Object[]{"RRR", "CAC", "PNP", 'R', new ItemStack(GSItems.RobotArm), 'C', "circuitElite", 'A', new ItemStack(GregTech_API.sBlockMachines, 1, 213), 'P', GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Uranium235, 1), 'N', GT_OreDictUnificator.get(OrePrefixes.block, Materials.NetherStar, 1)});
