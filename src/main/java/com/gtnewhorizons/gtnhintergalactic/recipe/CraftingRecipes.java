...
public class CraftingRecipes {
    ...
    public static void loadRecipes() {
        ...
        //Circuit Assembler
        RA.addCircuitAssemblerRecipe(new ItemStack[]{new ItemStack(GCItems.heavyPlatingTier1), ItemList.SchematicsTier1.getIS(), GT_OreDictUnificator.get("oc:keyboard", 1), ItemList.Display.getIS(), GT_ModHandler.getModItem("gregtech", "gt.metaitem.01", 1, 32682), GT_ModHandler.getModItem("gregtech", "gt.metaitem.01", 1, 32692)}, FluidRegistry.getFluidStack("molten.solderingalloy", 576), new ItemStack(GSItems.ControlComputer), 600, 480, true);
        ...
        RA.addCircuitAssemblerRecipe(new ItemStack[]{new ItemStack(AsteroidsItems.basicItem), ItemList.SchematicsTier3.getIS(), GT_OreDictUnificator.get("oc:keyboard", 1), ItemList.Display.getIS(), GT_ModHandler.getModItem("gregtech", "gt.metaitem.01", 1, 32683), GT_ModHandler.getModItem("gregtech", "gt.metaitem.01", 1, 32693)}, FluidRegistry.getFluidStack("molten.solderingalloy", 576), new ItemStack(GSItems.ControlComputer, 1, 2), 600, 1920, true);
        RA.addCircuitAssemblerRecipe(new ItemStack[]{ItemList.HeavyDutyPlateTier4.getIS(), ItemList.SchematicsTier4.getIS(), GT_OreDictUnificator.get("oc:keyboard", 1), ItemList.Display.getIS(), GT_ModHandler.getModItem("gregtech", "gt.metaitem.01", 1, 32684), GT_ModHandler.getModItem("gregtech", "gt.metaitem.01", 1, 32694)}, FluidRegistry.getFluidStack("molten.solderingalloy", 576), new ItemStack(GSItems.ControlComputer, 1, 3), 600, 7680, true);
        RA.addCircuitAssemblerRecipe(new ItemStack[]{ItemList.HeavyDutyPlateTier5.getIS(), ItemList.SchematicsTier5.getIS(), GT_OreDictUnificator.get("oc:keyboard", 1), ItemList.Display.getIS(), GT_ModHandler.getModItem("gregtech", "gt.metaitem.01", 1, 32685), GT_ModHandler.getModItem("gregtech", "gt.metaitem.01", 1, 32695)}, FluidRegistry.getFluidStack("molten.solderingalloy", 576), new ItemStack(GSItems.ControlComputer, 1, 4), 600, 30720, true);
        ...
        RA.addCircuitAssemblerRecipe(new ItemStack[]{ItemList.HeavyDutyPlateTier7.getIS(), ItemList.SchematicsTier7.getIS(), GT_OreDictUnificator.get("oc:keyboard", 1), ItemList.Display.getIS(), GT_ModHandler.getModItem("gregtech", "gt.metaitem.01", 1, 32686), GT_ModHandler.getModItem("gregtech", "gt.metaitem.01", 1, 32696)}, FluidRegistry.getFluidStack("molten.solderingalloy", 576), new ItemStack(GSItems.ControlComputer, 1, 6), 600, 122880, true);
        RA.addCircuitAssemblerRecipe(new ItemStack[]{ItemList.HeavyDutyPlateTier8.getIS(), ItemList.SchematicsTier8.getIS(), GT_OreDictUnificator.get("oc:keyboard", 1), ItemList.Display.getIS(), GT_ModHandler.getModItem("gregtech", "gt.metaitem.01", 1, 32687), GT_ModHandler.getModItem("gregtech", "gt.metaitem.01", 1, 32697)}, FluidRegistry.getFluidStack("molten.solderingalloy", 576), new ItemStack(GSItems.ControlComputer, 1, 7), 600, 491520, true);
        ...
        RecipeUtil.addRecipe(new ItemStack(GCBlocks.nasaWorkbench), new Object[]{"RRR", "CAC", "PHP", 'R', GT_ModHandler.getModItem("gregtech", "gt.metaitem.01", 1, 32652), 'C', "circuitData", 'A', new ItemStack(GregTech_API.sBlockMachines, 1, 213), 'P', GT_OreDictUnificator.get(OrePrefixes.plate, Materials.StainlessSteel, 1), 'H', new ItemStack(GregTech_API.sBlockMachines, 1, 13)});
