...
public class CraftingRecipes {
    ...
    public static void loadRecipes() {
        ...
        if (FluidRegistry.getFluid("molten.indalloy140") != null) {
        ...
        RA.addAssemblerRecipe(
            new ItemStack[] { new ItemStack(AsteroidsItems.basicItem, 1, 7),
                GT_OreDictUnificator.get(OrePrefixes.foil, Materials.Titanium, 8), new ItemStack(tungstenString, 8),
        ...
        RA.addAssemblerRecipe(
            new ItemStack[] { new ItemStack(case1), new ItemStack(keyboard), new ItemStack(display),
                ItemList.Emitter_HV.get(1), ItemList.Sensor_HV.get(1), new ItemStack(GCItems.heavyPlatingTier1) },
        ...
        RA.addAssemblerRecipe(
            new ItemStack[] { new ItemStack(case1), new ItemStack(keyboard), new ItemStack(display),
                ItemList.Emitter_IV.get(1), ItemList.Sensor_IV.get(1), new ItemStack(AsteroidsItems.basicItem) },
        ...
        RA.addAssemblerRecipe(
            new ItemStack[] { new ItemStack(case2), new ItemStack(keyboard), new ItemStack(display),
                ItemList.Emitter_IV.get(1), ItemList.Sensor_IV.get(1), new ItemStack(GSItems.heavyDutyPlateT4) },
        ...
        RA.addAssemblerRecipe(
            new ItemStack[] { new ItemStack(case2), new ItemStack(keyboard), new ItemStack(display),
                ItemList.Emitter_LuV.get(1), ItemList.Sensor_LuV.get(1), new ItemStack(GSItems.heavyDutyPlateT5) },
        ...
        RA.addAssemblerRecipe(
            new ItemStack[] { new ItemStack(case3), new ItemStack(keyboard), new ItemStack(display),
                ItemList.Emitter_ZPM.get(1), ItemList.Sensor_ZPM.get(1), new ItemStack(GSItems.heavyDutyPlateT6) },
        ...
        RA.addAssemblerRecipe(
            new ItemStack[] { new ItemStack(case3), new ItemStack(keyboard), new ItemStack(display),
                ItemList.Emitter_UV.get(1), ItemList.Sensor_UV.get(1), new ItemStack(GSItems.heavyDutyPlateT7) },
        ...
        RA.addAssemblerRecipe(
            new ItemStack[] { new ItemStack(case3), new ItemStack(keyboard), new ItemStack(display),
                ItemList.Emitter_UV.get(1), ItemList.Sensor_UV.get(1), new ItemStack(GSItems.heavyDutyPlateT8) },
        ...
        RA.addAssemblerRecipe(
            new ItemStack[] { new ItemStack(case1), new ItemStack(GCItems.basicItem, 1, 14),
                GT_OreDictUnificator.get("circuitData", 1), ItemList.Emitter_HV.get(1), ItemList.Sensor_HV.get(1),
        ...
        RA.addAssemblerRecipe(
            new ItemStack[] { new ItemStack(case1), new ItemStack(GCItems.basicItem, 1, 14),
                GT_OreDictUnificator.get("circuitElite", 1), ItemList.Emitter_EV.get(1), ItemList.Sensor_EV.get(1),
        ...
        RA.addAssemblerRecipe(
            new ItemStack[] { new ItemStack(case1), new ItemStack(GCItems.basicItem, 1, 14),
                GT_OreDictUnificator.get("circuitMaster", 1), ItemList.Emitter_IV.get(1), ItemList.Sensor_IV.get(1),
        ...
        TT_recipeAdder.addResearchableAssemblylineRecipe(
            ...
            8000000,
            16,
            new Object[] { ItemList.Cover_SolarPanel_LuV.get(4), new ItemStack(GSItems.DysonSwarmItems, 8, 3),
                new Object[] { OrePrefixes.circuit.get(Materials.Infinite), 2L }, ItemList.Circuit_Chip_QPIC.get(2),
                ItemList.Emitter_UEV.get(1), ItemList.Sensor_UEV.get(1), new ItemStack(ocItem, 4, 91) },
        ...
        TT_recipeAdder.addResearchableAssemblylineRecipe( // Dyson Swarm Energy Receiver Base Casing
            ...
            2000000,
            32,
            new ItemStack[] { new ItemStack(ItemRegistry.energyDistributor[9].getItem(), 4, 12610),
            ...
            new FluidStack[] { GSMaterials.liquidHelium.getFluidOrGas(50000), Materials.SuperCoolant.getFluid(16000),
        ...
        TT_recipeAdder.addResearchableAssemblylineRecipe( // Dyson Swarm Energy Receiver Dish Block
            ...
            2000000,
            32,
            new ItemStack[] { new ItemStack(GSItems.DysonSwarmItems, 64, 3),

                new ItemStack(advancedRadiationProtectionPlate, 64), ItemList.Reactor_Coolant_Sp_6.get(1),
                ItemList.Reactor_Coolant_Sp_6.get(1), ItemList.Reactor_Coolant_Sp_6.get(1),
                ItemList.Reactor_Coolant_Sp_6.get(1),
                GT_OreDictUnificator.get(OrePrefixes.pipeMedium, Materials.Infinity, 8), new ItemStack(frfCoil3, 2), },
        ...
        TT_recipeAdder.addResearchableAssemblylineRecipe( // Dyson Swarm Module Deployment Unit Base Casing
            ...
            2000000,
            32,
            new ItemStack[] { new ItemStack(GregTech_API.sBlockMachines, 4, 11231), new ItemStack(pikoCircuit, 4),
        ...
        TT_recipeAdder.addResearchableAssemblylineRecipe( // Dyson Swarm Module Deployment Unit Core
            ...
            2000000,
            32,
            new ItemStack[] { new ItemStack(GregTech_API.sBlockMachines, 4, 11231),
                ItemList.Conveyor_Module_UIV.get(32),

                ItemList.Robot_Arm_UIV.get(32), ItemList.Electric_Piston_UIV.get(32), new ItemStack(Blocks.dropper, 64),
        ...
        TT_recipeAdder.addResearchableAssemblylineRecipe( // Dyson Swarm Control Center Base Casing
            ...
            2000000,
            32,
            new ItemStack[] { new ItemStack(GregTech_API.sBlockMachines, 4, 11231), new ItemStack(ocItem, 4, 103),

                new ItemStack(pikoCircuit, 4), CustomItemList.Machine_Multi_Computer.get(4), },
            new FluidStack[] { Materials.SuperCoolant.getFluid(32000), new FluidStack(solderUEV, 11520),
        ...
        TT_recipeAdder.addResearchableAssemblylineRecipe( // Dyson Swarm Control Center Primary Windings
            ...
            2000000,
            32,
            new ItemStack[] { ItemList.Circuit_Chip_QPIC.get(4), new ItemStack(micaInsulator, 64),
                new ItemStack(micaInsulator, 64), new ItemStack(micaInsulator, 64), CustomItemList.eM_Coil.get(4),
                new ItemStack(micaInsulator, 64), new ItemStack(micaInsulator, 64), new ItemStack(micaInsulator, 64),
        ...
        TT_recipeAdder.addResearchableAssemblylineRecipe( // Dyson Swarm Control Center Secondary Windings
            ...
            new ItemStack[] { ItemList.Circuit_Chip_QPIC.get(4), new ItemStack(micaInsulator, 64),
                new ItemStack(micaInsulator, 64), new ItemStack(micaInsulator, 64),
                ItemList.Casing_Coil_AwakenedDraconium.get(4), new ItemStack(micaInsulator, 64),
                new ItemStack(micaInsulator, 64), new ItemStack(micaInsulator, 64), new ItemStack(micaInsulator, 64),
        ...
        TT_recipeAdder.addResearchableAssemblylineRecipe( // Dyson Swarm Controller
            ...
            16,
            new ItemStack[] { new ItemStack(GregTech_API.sBlockMachines, 4, 11231),
                new ItemStack(irradiantReinforcedBedrockiumPlate, 4), new ItemStack(pikoCircuit, 8),
                new ItemStack(magicalMemory, 4), new ItemStack(ocItem, 8, 103), },
        ...
        if (NewHorizonsCoreMod.isModLoaded()) {
            RecipeUtil.addRecipe(
                ...
                new Object[] { "MWM", "CTC", "MWM", 'M', new ItemStack(GSItems.CompressedPlates, 1, 5), 'W', waferT3,
                    'C', new ItemStack(GCBlocks.aluminumWire, 1, 1), 'T', new ItemStack(GregTech_API.sBlockCasings4) });
            RecipeUtil.addRecipe(
        ...
        if (NewHorizonsCoreMod.isModLoaded()) {
            RecipeUtil.addRecipe(
                ...
                new Object[] { "LMS", "m S", "LMS", 'L',
                    ...
                    getGTNHItem("MytrylCrystal"), 'S', GT_ModHandler.getModItem("TConstruct", "bowstring", 1, 2), 'm',
        ...
        RecipeUtil.addRecipe(
            ...
            new Object[] { "LLL", "LHL", "D D", 'L', new ItemStack(GSItems.CompressedPlates, 1, 3), 'H',
                "craftingToolHardHammer", 'D', GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Desh, 1) });
        RecipeUtil.addRecipe(
        ...
        RecipeUtil.addRecipe(
            ...
            new Object[] { "FPF", "CLC", "FCF", 'F', GT_OreDictUnificator.get(OrePrefixes.foil, Materials.Gold, 1), 'P',
        ...
        RecipeUtil.addRecipe(
            ...
            new Object[] { "FCH", "DPD", "WBW", 'F', "craftingToolFile", 'C',
                ...
                GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Desh, 1), 'P', new ItemStack(GCItems.flagPole),
        ...
        RecipeUtil.addRecipe(
            ...
            new Object[] { "NNL", "MRA", "PCR", 'N',
                ...
                new ItemStack(GCItems.sensorLens), 'M', new ItemStack(GT_MetaGenerated_Item_01.INSTANCE, 1, 32602), 'R',
