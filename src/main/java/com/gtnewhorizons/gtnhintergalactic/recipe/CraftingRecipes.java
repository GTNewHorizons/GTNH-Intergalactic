...
public class CraftingRecipes {
    ...
    public static void loadRecipes() {
        ...
        //Circuit Assembler
        RA.addCircuitAssemblerRecipe(new ItemStack[]{new ItemStack(GCItems.heavyPlatingTier1), GT_OreDictUnificator.get("oc:keyboard", 1), ItemList.Display.getIS(), GT_ModHandler.getModItem("gregtech", "gt.metaitem.01", 1, 32682), GT_ModHandler.getModItem("gregtech", "gt.metaitem.01", 1, 32692)}, FluidRegistry.getFluidStack("molten.solderingalloy", 576), new ItemStack(GSItems.ControlComputer, 1, 1), 600, 480, true);
        RA.addCircuitAssemblerRecipe(new ItemStack[]{new ItemStack(MarsItems.marsItemBasic, 1, 3), GT_OreDictUnificator.get("oc:keyboard", 1), ItemList.Display.getIS(), GT_ModHandler.getModItem("gregtech", "gt.metaitem.01", 1, 32683), GT_ModHandler.getModItem("gregtech", "gt.metaitem.01", 1, 32693)}, FluidRegistry.getFluidStack("molten.solderingalloy", 864), new ItemStack(GSItems.ControlComputer, 1, 2), 600, 1920, true);
        RA.addCircuitAssemblerRecipe(new ItemStack[]{new ItemStack(AsteroidsItems.basicItem), GT_OreDictUnificator.get("oc:keyboard", 1), ItemList.Display.getIS(), GT_ModHandler.getModItem("gregtech", "gt.metaitem.01", 1, 32684), GT_ModHandler.getModItem("gregtech", "gt.metaitem.01", 1, 32694)}, FluidRegistry.getFluidStack("molten.solderingalloy", 1152), new ItemStack(GSItems.ControlComputer, 1, 3), 600, 7680, true);
        RA.addCircuitAssemblerRecipe(new ItemStack[]{ItemList.HeavyDutyPlateTier4.getIS(), GT_OreDictUnificator.get("oc:keyboard", 1), ItemList.Display.getIS(), GT_ModHandler.getModItem("gregtech", "gt.metaitem.01", 1, 32685), GT_ModHandler.getModItem("gregtech", "gt.metaitem.01", 1, 32695)}, FluidRegistry.getFluidStack("molten.solderingalloy", 1728), new ItemStack(GSItems.ControlComputer, 1, 4), 600, 30720, true);
        RA.addCircuitAssemblerRecipe(new ItemStack[]{ItemList.HeavyDutyPlateTier5.getIS(), GT_OreDictUnificator.get("oc:keyboard", 1), ItemList.Display.getIS(), GT_ModHandler.getModItem("gregtech", "gt.metaitem.01", 1, 32686), GT_ModHandler.getModItem("gregtech", "gt.metaitem.01", 1, 32696)}, FluidRegistry.getFluidStack("molten.solderingalloy", 2304), new ItemStack(GSItems.ControlComputer, 1, 5), 600, 122880, true);
        RA.addCircuitAssemblerRecipe(new ItemStack[]{ItemList.HeavyDutyPlateTier6.getIS(), GT_OreDictUnificator.get("oc:keyboard", 1), ItemList.Display.getIS(), GT_ModHandler.getModItem("gregtech", "gt.metaitem.01", 1, 32687), GT_ModHandler.getModItem("gregtech", "gt.metaitem.01", 1, 32697)}, FluidRegistry.getFluidStack("molten.solderingalloy", 3456), new ItemStack(GSItems.ControlComputer, 1, 6), 600, 491520, true);
        RA.addCircuitAssemblerRecipe(new ItemStack[]{ItemList.HeavyDutyPlateTier7.getIS(), GT_OreDictUnificator.get("oc:keyboard", 1), ItemList.Display.getIS(), GT_ModHandler.getModItem("gregtech", "gt.metaitem.01", 1, 32688), GT_ModHandler.getModItem("gregtech", "gt.metaitem.01", 1, 32698)}, FluidRegistry.getFluidStack("molten.solderingalloy", 4608), new ItemStack(GSItems.ControlComputer, 1, 7), 600, 1966080, true);
        RA.addCircuitAssemblerRecipe(new ItemStack[]{ItemList.HeavyDutyPlateTier8.getIS(), GT_OreDictUnificator.get("oc:keyboard", 1), ItemList.Display.getIS(), GT_ModHandler.getModItem("gregtech", "gt.metaitem.01", 1, 32689), GT_ModHandler.getModItem("gregtech", "gt.metaitem.01", 1, 32699)}, FluidRegistry.getFluidStack("molten.solderingalloy", 6912), new ItemStack(GSItems.ControlComputer, 1, 8), 600, 7864320, true);
        ...
        RA.addCircuitAssemblerRecipe(new ItemStack[]{new ItemStack(MarsItems.marsItemBasic, 1, 3), new ItemStack(GCItems.basicItem, 1, 14), GT_OreDictUnificator.get("circuitElite", 1), GT_ModHandler.getModItem("gregtech", "gt.metaitem.01", 1, 32683), GT_ModHandler.getModItem("gregtech", "gt.metaitem.01", 1, 32693)}, FluidRegistry.getFluidStack("molten.solderingalloy", 864), new ItemStack(GSItems.ControlComputer, 1, 101), 600, 1920, true);
        RA.addCircuitAssemblerRecipe(new ItemStack[]{new ItemStack(AsteroidsItems.basicItem), new ItemStack(GCItems.basicItem, 1, 14), GT_OreDictUnificator.get("circuitMaster", 1), GT_ModHandler.getModItem("gregtech", "gt.metaitem.01", 1, 32684), GT_ModHandler.getModItem("gregtech", "gt.metaitem.01", 1, 32694)}, FluidRegistry.getFluidStack("molten.solderingalloy", 1152), new ItemStack(GSItems.ControlComputer, 1, 102), 600, 7680, true);
        ...
        RecipeUtil.addRecipe(new ItemStack(GSBlocks.SolarWindPanel), new Object[]{"TFT", "APA", "MWS", 'T', new ItemStack(AsteroidsItems.basicItem, 1, 6), 'F', new ItemStack(GSItems.SolarFlares, 1, 1), 'A', new ItemStack(GCBlocks.aluminumWire, 1, 1), 'P', new ItemStack(GCItems.flagPole), 'M', GT_ModHandler.getModItem("gregtech", "gt.metaitem.01", 1, 32600), 'W', new ItemStack(GCItems.basicItem, 1, 14), 'S', GT_ModHandler.getModItem("gregtech", "gt.metaitem.01", 1, 32690)});
        RecipeUtil.addRecipe(new ItemStack(GSBlocks.SolarPanel), new Object[]{"DSD", "AFA", "MWs", 'D', new ItemStack(GSItems.CompressedPlates, 1, 2), 'S', new ItemStack(GCItems.basicItem, 1, 1), 'A', new ItemStack(GCBlocks.aluminumWire, 1, 1), 'F', new ItemStack(GSBlocks.MachineFrames), 'M', GT_ModHandler.getModItem("gregtech", "gt.metaitem.01", 1, 32601), 'W', ItemList.WaferTier3.getIS(), 's', GT_ModHandler.getModItem("gregtech", "gt.metaitem.01", 1, 32691)});
