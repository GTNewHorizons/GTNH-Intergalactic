...
public class CraftingRecipes {
    ...
    public static void loadRecipes() {
        ...
        RA.addCircuitAssemblerRecipe(new ItemStack[]{ItemList.HeavyDutyPlateTier4.getIS(), GT_OreDictUnificator.get("oc:keyboard", 1), ItemList.Display.getIS(), getGTItem(32684), getGTItem(32694)}, FluidRegistry.getFluidStack("molten.solderingalloy", 1728), new ItemStack(GSItems.ControlComputer, 1, 4), 600, 7680, true);
        RA.addCircuitAssemblerRecipe(new ItemStack[]{ItemList.HeavyDutyPlateTier5.getIS(), GT_OreDictUnificator.get("oc:keyboard", 1), ItemList.Display.getIS(), getGTItem(32685), getGTItem(32695)}, FluidRegistry.getFluidStack("molten.solderingalloy", 2304), new ItemStack(GSItems.ControlComputer, 1, 5), 600, 30720, true);
        RA.addCircuitAssemblerRecipe(new ItemStack[]{ItemList.HeavyDutyPlateTier6.getIS(), GT_OreDictUnificator.get("oc:keyboard", 1), ItemList.Display.getIS(), getGTItem(32686), getGTItem(32696)}, FluidRegistry.getFluidStack("molten.solderingalloy", 3456), new ItemStack(GSItems.ControlComputer, 1, 6), 600, 122880, true);
        RA.addCircuitAssemblerRecipe(new ItemStack[]{ItemList.HeavyDutyPlateTier7.getIS(), GT_OreDictUnificator.get("oc:keyboard", 1), ItemList.Display.getIS(), getGTItem(32687), getGTItem(32697)}, FluidRegistry.getFluidStack("molten.solderingalloy", 4608), new ItemStack(GSItems.ControlComputer, 1, 7), 600, 491520, true);
        RA.addCircuitAssemblerRecipe(new ItemStack[]{ItemList.HeavyDutyPlateTier8.getIS(), GT_OreDictUnificator.get("oc:keyboard", 1), ItemList.Display.getIS(), getGTItem(32687), getGTItem(32697)}, FluidRegistry.getFluidStack("molten.solderingalloy", 6912), new ItemStack(GSItems.ControlComputer, 1, 8), 600, 491520, true);
