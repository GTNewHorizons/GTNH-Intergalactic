...
public class CraftingRecipes {
    ...
    public static void loadRecipes() {
        ...
        RA.addCircuitAssemblerRecipe(new ItemStack[]{new ItemStack(MarsItems.marsItemBasic, 1, 3), ItemList.SchematicsCargoRocket.getIS(), new ItemStack(GCItems.basicItem, 1, 14), GT_OreDictUnificator.get("circuitElite", 1), GT_ModHandler.getModItem("gregtech", "gt.metaitem.01", 1, 32683), GT_ModHandler.getModItem("gregtech", "gt.metaitem.01", 1, 32693)}, FluidRegistry.getFluidStack("molten.solderingalloy", 576), new ItemStack(GSItems.ControlComputer, 1, 64), 600, 1920, true);
        RA.addCircuitAssemblerRecipe(new ItemStack[]{new ItemStack(GCItems.heavyPlatingTier1), ItemList.SchematicsMoonBuggy.getIS(), new ItemStack(GCItems.basicItem, 1, 14), GT_OreDictUnificator.get("circuitData", 1), GT_ModHandler.getModItem("gregtech", "gt.metaitem.01", 1, 32682), GT_ModHandler.getModItem("gregtech", "gt.metaitem.01", 1, 32692)}, FluidRegistry.getFluidStack("molten.solderingalloy", 576), new ItemStack(GSItems.ControlComputer, 1, 65), 600, 480, true);
        RA.addCircuitAssemblerRecipe(new ItemStack[]{new ItemStack(AsteroidsItems.basicItem), ItemList.SchematicsMoonBuggy.getIS(), new ItemStack(GCItems.basicItem, 1, 14), GT_OreDictUnificator.get("circuitMaster", 1), GT_ModHandler.getModItem("gregtech", "gt.metaitem.01", 1, 32684), GT_ModHandler.getModItem("gregtech", "gt.metaitem.01", 1, 32694)}, FluidRegistry.getFluidStack("molten.solderingalloy", 576), new ItemStack(GSItems.ControlComputer, 1, 66), 600, 7680, true);
